...
@Component({
  ...
  template: `
      <div class="sidebar" id="graph">
        <div class="pure-g">
          <div style="flex:1;display:block;margin:auto;" class="pure-u-1-24">
            <svg (click)="periodBack()" width="75%" viewBox="0 0 10 20">
          ...
          <div style="flex:1;display:block;margin:auto;" class="pure-u-1-24">
            <svg (click)="periodForward()" width="75%" viewBox="0 0 10 20">
